...
shared_memory_t::shared_memory_t(const std::string& shared_memory_name, size_t shared_memory_size) {
    ...
    m_managed_shared_memory = std::move(managed_shared_memory(create_only, m_shared_memory_name.c_str(), shared_memory_size));
...
shared_memory_t::shared_memory_t(const std::string& shared_memory_name) {
    ...
    m_managed_shared_memory = std::move(managed_shared_memory(open_only, m_shared_memory_name.c_str()));
}
